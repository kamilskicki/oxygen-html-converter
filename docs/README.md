...
This folder contains public product and release documentation for the Core plugin.

Recommended reading order:

1. [Supported Scope](SUPPORTED_SCOPE.md)
...
- `SUPPORTED_SCOPE.md`
  - what Core is expected to handle today
  - what is intentionally out of scope
- `DOD-0.9.0-BETA.md`
  - the release quality bar for the current beta line
- `OPEN_CORE.md`
